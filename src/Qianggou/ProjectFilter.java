...
public class ProjectFilter {
	...
	public void setRate(String min,String max){
		minRate=min;
		maxRate=max;
	}
	...
	public void setMinMoney(String min) {
		this.minMoney = min;
	}
	...
	public void setMinDays(String min) {
		this.minDays = min;
	}
	...
	public void setMaxDays(String max) {
		this.maxDays = max;
	}
	...
	public String getURL(){
		return "https://list.lu.com/list/transfer-p2p?minMoney="+minMoney+"&maxMoney="+maxMoney
